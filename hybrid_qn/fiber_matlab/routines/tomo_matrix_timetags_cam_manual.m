function out = tomo_matrix_timetags_cam_manual(timetag_root_folder, trics_root_folder, trics_folder_arr,  timetag_files,timetag_bases,  ChRaman, CH1, CH2, ChCycle, threshold, doppler_threshold, seq_cycles,  gate_start, gate_stop, gate_number)
...
%out.Counts1{gate_number} = Coutns1;
