function [Counts, attempts, Noise_counts, eff, noise_prob] = efficiency_from_hystogram4(input, fig, attempts, gate, delay_arr, noise_delay,noise_window, do_noise)
if nargin<8
  do_noise = 0;
end
...
binsize = delay_arr(2)-delay_arr(1);
...
if (do_noise)
    draw_gate([delay_arr(gate_stop_bin+delay), delay_arr(gate_stop_bin+delay+noise_bins)], fig, 'green') ;
end
Counts = (counts);
Noise_counts = noisecounts;